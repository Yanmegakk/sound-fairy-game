...
class SoundFairyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        # ゲーム状態管理
        self.game = None
        self.current_screen = "title"  # "title", "select", "instruction", "game", "result"
    ...
    def draw_grid(self):
        ...
        for i in range(grid_size + 1):
            ...
            arcade.draw_line(
                ...
                grid_start_x + i * cell_size, grid_start_y + total_height,
                line_color, 2
            )
            # 横線
            arcade.draw_line(
                grid_start_x, grid_start_y + i * cell_size,
                grid_start_x + total_width, grid_start_y + i * cell_size,
                line_color, 2
            )
    ...
    def draw_result(self):
        ...
        restart_text = arcade.Text(
            "Press ENTER to play again with same difficulty, or Q to quit",
            WIDTH // 2, 30,
            TEXT_COLOR, FONT_SIZE_SMALL,
            anchor_x="center", anchor_y="bottom"
        )
    ...
    def draw_result_grid(self):
        ...
        arcade.draw_circle_outline(target_cell_x, target_cell_y, 12, GRID_SELECTED_COLOR, 2)
        ...
        for speaker_id in range(self.game.num_speakers):
            ...
            if speaker_id == self.game.target_speaker:
                label_text = arcade.Text(
                    f"● {speaker_name} (目標)",
                    WIDTH // 2 + (speaker_id - 1) * 150, label_y,
                    SUCCESS_COLOR, FONT_SIZE_SMALL,
    ...
    def start_instruction(self):
        ...
        # サンプル音声を再生
        self.play_sample_voice()
        print(f"Instruction開始: {self.selected_grid_size}×{self.selected_grid_size}, {self.selected_num_speakers}人")
    ...
    def handle_cell_confirm(self):
        ...
        if is_correct:
            ...
            self.feedback_time = 0
            print(f"不正解。{closest_name}が一番近い (残りライフ: {self.game.remaining_life})")
